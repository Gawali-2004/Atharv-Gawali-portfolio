...
const Projects = () => {
  const projectData = [
    ...
    {
      title: "Weather App",
      desc: "This Weather App is a real-time weather forecasting application that works with the OpenWeather API to get accurate and real-time weather data for cities all around the world. The app features core weather functionalities and allows for location-based category filtering in order to help users see weather insight based on the relevant field such as General, Technology, and Medical.",
      github: "https://github.com/Gawali-2004/WeatherApp",
      website: "https://weatherapp-atharv.netlify.app/",
      tech: ["React", "Bootstrap", "JavaScript", "API", "OpenWeather", "HTML"],
    },
  ];
